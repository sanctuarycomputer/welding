...
// [x] Pull out of Nonce Signing
// [x] Disconnect
// [x] Combine Session & Account?
// [x] SSR?
// [x] Loading Session?
      ...
      <div className="h-screen sm:h-auto flex flex-col">
        ...
        <div className="py-16 px-4 text-center flex relative flex-grow justify-center items-center flex-col border-b border-color">
          ...
          {(
            ...
            !sessionDataLoading) && (
            <p className="pt-2 font-semibold">
              Welding requires that you <a className="underline" href="https://login.xyz/" target="_blank" rel="noreferrer">Sign-in with Ethereum</a> to enable secure communication between our frontend and API. Learn more <a href="https://docs.login.xyz/general-information/siwe-overview/eip-4361" target="_blank" rel="noreferrer" className="underline">here</a>.
            </p>
          )}
        </div>
        ...
        <div className="p-4 flex flex-row-reverse justify-between">
          <Button
            ...
            onClick={sign}
            disabled={nonceState.loading || !!nonceState.error || signingState.loading || !nonceState.nonce}
          />
        </div>
      </div>
    </Modal>
